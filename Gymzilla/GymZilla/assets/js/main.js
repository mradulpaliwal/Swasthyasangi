...
<header class="bg-white shadow-lg h-24 hidden md:flex">
  <a href="" class="border flex-shrink-0 flex items-center justify-center px-4 lg:px-6 xl:px-8">
    <img class="" src="/assets/images/gymzilla-logo.png" alt="" / width="180">
  </a>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            <input type="text" id="footer-field" name="footer-field" class="w-full bg-gray-100 bg-opacity-50 border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="contact@gymzilla.com">
          </div>
        ...
        <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Get Latest News & Updates 
          <br class="lg:block hidden">Through GymZilla Newsletter.
        </p>
      </div>
    </div>
  </div>
  <div class="bg-gray-100">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023  —
        ...
        <img src="/assets/images/gymzilla-logo.png" width="190">
        All Rights Reserved.
        </a>
      </p>
